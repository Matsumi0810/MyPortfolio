...
const works = [
  {
    ...
    desc: "初めて制作した水族館のWEBサイトです。jsでアニメーションを実装し、動きのあるサイトに仕上げました。性格診断占いや、名前募集の応募フォームにもこだわりました。初めて作ったウェブサイトなので時間もかかり、作りきれていないページもありますが、学びも多かったです。",
  ...
  },
  {
    ...
    desc: "microCMSやSSGフォームとの連携、モーダル表示など、JavaScriptを活用して動的な要素を実装したカフェのWEBサイトです。期間限定メニューやお知らせなど、クライアントが簡単に更新できるように工夫しました。",
